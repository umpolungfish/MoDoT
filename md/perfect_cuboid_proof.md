...
<p><span
class="math display">⟨<em>⊢</em><sub><em>C</em></sub>; <em>⊣</em><sub>6</sub>; <em>></em><sub>¯</sub>; <em><</em><sub>˙</sub>; ⋈<sup>ì</sup>; <em>⊤</em><sup>Ù</sup>; <em>∈</em><sub><em>β</em></sub>; ∋<sup>∧</sup>; ⊙<sub>ž</sub>; ⊥<sub>Ñ</sub>; <em>Σ</em><sub><em>S</em></sub>; <em>⊡</em><sub>Å</sub>⟩</span></p>
...
<p><span
class="math display">⟨<em>⊢</em><sub><em>ω</em></sub>; <em>⊣</em><sub><em>O</em></sub>; <em>></em><sub>=</sub>; <em><</em><sub>}</sub>; ⋈<sup>ż</sup>; <em>⊤</em><sup>@</sup>; <em>∈</em><sub>ʔ</sub>; ∋<sup>ˌ</sup>; ⊙<sub>ÿ</sub>; ⊥<sub><em>A</em></sub>; <em>Σ</em><sub>ï</sub>; <em>⊡</em><sub><em>z</em></sub>⟩</span></p>
...
class="math inline">⊥<sub><em>A</em></sub></span> memory discipline —
...
class="math inline"><em>⊡</em><sub><em>z</em></sub></span> topological
...
<td><span class="math inline"><em>⊢</em><sub><em>C</em></sub></span>
(finite surface)</td>
<td><span class="math inline"><em>⊢</em><sub><em>ω</em></sub></span>
(self-written state)</td>
</tr>
<tr>
<td><span class="math inline"><em>T</em></span></td>
<td><span class="math inline"><em>⊣</em><sub>6</sub></span>
(branching)</td>
<td><span class="math inline"><em>⊣</em><sub><em>O</em></sub></span>
(self-referential)</td>
</tr>
<tr>
<td><span class="math inline"><em>R</em></span></td>
<td><span class="math inline"><em>></em><sub>¯</sub></span>
(supervenience)</td>
<td><span class="math inline"><em>></em><sub>=</sub></span>
(bidirectional)</td>
</tr>
...
<td><span class="math inline"><em><</em><sub>˙</sub></span></td>
<td><span class="math inline"><em><</em><sub>}</sub></span>
(Frobenius-special)</td>
</tr>
<tr>
<td><span class="math inline"><em>F</em></span></td>
<td><span class="math inline">⋈<sup>ì</sup></span> (classical)</td>
<td><span class="math inline">⋈<sup>ż</sup></span>
(quantum-coherent)</td>
</tr>
<tr>
<td><span class="math inline"><em>K</em></span></td>
<td><span class="math inline"><em>⊤</em><sup>Ù</sup></span>
(frozen)</td>
<td><span class="math inline"><em>⊤</em><sup>@</sup></span>
(near-equilibrium)</td>
</tr>
<tr>
...
<td><span class="math inline">∋<sup>∧</sup></span> (conjunctive)</td>
<td><span class="math inline">∋<sup>ˌ</sup></span> (sequential)</td>
</tr>
<tr>
<td><span class="math inline"><em><</em></span></td>
...
<td><span class="math inline">⊥<sub>Ñ</sub></span> (memoryless)</td>
<td><span class="math inline">⊥<sub><em>A</em></sub></span>
(two-step)</td>
</tr>
<tr>
...
<tr>
<td><span class="math inline"><em>⊡</em></span></td>
<td><span class="math inline"><em>⊡</em><sub>Å</sub></span></td>
<td><span class="math inline"><em>⊡</em><sub><em>z</em></sub></span>
(integer winding)</td>
</tr>
</tbody>
</table>
...
class="math inline"><em><</em></span>, bidirectionality from <span
class="math inline"><em>R</em></span>. The promotions are interdependent
— you cannot have <span
class="math inline"><em>⊣</em><sub><em>O</em></sub></span> without <span
class="math inline"><em>⊢</em><sub><em>ω</em></sub></span>, and you
cannot have <span class="math inline"><em><</em><sub>}</sub></span>
without <span class="math inline"><em>></em><sub>=</sub></span>.</p>
...
class="math inline"><em>⊤</em><sup>@</sup></span> kinetics.</p>
