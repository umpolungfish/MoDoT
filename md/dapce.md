...
DOES A PERFECT CUBOID EXIST?
  ...
  Open (B): cl9nk perfect_cuboid_proof — tier O_inf, d(L9)=1.5494, 8 promotions outstanding (⊢ ⊣ > < ⊤ Γ ɢ Ħ). click witness ✗ (θ=0.50 not met). set thermoneutral. Derived states not catalog-addressable.
