...
IG_TOOL_ARGS: Dict[str, List[str]] = {
    ...
    "check_imscription": ["name"],
    "ouroborics": ["name"],
    "compute_distance": ["name_a", "name_b"],
    "compute_conflict_distance": ["name_a", "name_b"],
    ...
    "emergence_frontier": ["name"],
    "compute_promotions": ["name_source", "name_target"],
    "predict_from_promotions": ["promoted_primitives"],
    "register_promotion_pattern": ["promoted_primitives", "behavior"],
    "crystal_encode": ["name"],
    "crystal_decode": ["address"],
    "crystal_navigate": ["name"],
    "crystal_count": [],
    "crystal_tier_census": [],
    "crystal_nearest": ["name"],
    "crystal_tier_gap_ladder": ["name"],
    "quiver_encode": ["name"],
    "domain_info": ["domain"],
    ...
    "zfc_formula": ["name"],
    "zfc_probe": ["name"],
    "zfc_catalog_probe": ["name"],
    "aleph_encode": ["text"],
    "aleph_distance": ["a", "b"],
    "riemann_xi_info": [],
    "ask_question": ["question"],
    "record_insight": ["content"],
}
